  ...
  return (
    <div className='div-container-call'>
        ...
        <div className='div-container-text-call p-5'>
            ...
            <p className='text-call py-2'>El equipo de <strong className='title-strong'>Art Set</strong> tiene lo mejor para vos, incrementa valor a tu negocio con presencia en internet. Desarrollamos tu sitio WEB, Tienda On-line, Aplicación Móvil y mucho más.  </p>
            <div className='py-3'>
